...
export function UploadForm({ today, maxMb }: { today: string; maxMb: number }) {
  ...
  const [result, setResult] = useState<{ id: string; version: number; duplicateCount: number; description?: string } | null>(null);
